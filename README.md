...
|---|---|---|
| Praktikum 1 | PHP Framework | Instalasi CI4, konfigurasi routing, controller, view, dan layout sederhana |
| Praktikum 2 | CRUD Artikel | Model data, interaksi database, tambah, baca, edit, dan hapus artikel |
| Praktikum 3 | View Layout dan View Cell | Modularisasi layout utama dan pembuatan komponen artikel terkini di sidebar |
| Praktikum 4 | Login dan Auth Filter | Otentikasi admin, session, dan proteksi rute admin menggunakan filter |
| Praktikum 5 | Pagination dan Pencarian | Filter data menggunakan query pencarian dan pagination data artikel |
| Praktikum 6 | Relasi Tabel | Relasi tabel artikel dengan tabel kategori menggunakan Query Builder |
| Praktikum 7 | Upload File | Unggah file gambar pada artikel, validasi, dan hapus berkas gambar dari storage |
| Praktikum 8 | AJAX | Halaman pengelolaan artikel berbasis AJAX tanpa reload halaman penuh |
| Praktikum 10 | REST API | Penyediaan endpoint RESTful API format JSON untuk artikel |
| Praktikum 11 | VueJS Frontend API | Frontend VueJS terpisah untuk mengkonsumsi data dari REST API |
| Praktikum 12 | VueJS Komponen & Routing SPA | Implementasi Single Page Application (SPA) menggunakan Vue Router |
| Praktikum 13 | Autentikasi SPA | Login frontend SPA, penyimpanan token di localStorage, dan Navigation Guards |
| Praktikum 14 | Keamanan API | Pembatasan akses API manipulasi data menggunakan Token Bearer dan Axios Interceptors |
